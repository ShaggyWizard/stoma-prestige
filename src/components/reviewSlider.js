...
export default function ReviewSlider({ children, nodes }) {
    ...
    return (
        ...
        >
            ...
            <Swiper ref={swiper} style={{overflow:"visible"}} slidesPerView={'auto'} spaceBetween={8} 
                modules={[Autoplay]}  autoplay={{ delay: 5000, disableOnInteraction: false, }}
                className="main:hidden review-slider w-full h-[300px] overflow-visible transition-all duration-1000 delay-[800ms]
            ...
            <Swiper ref={swiper} style={{overflow:"visible"}} slidesPerView={3} spaceBetween={8} 
                modules={[Autoplay]}  autoplay={{ delay: 5000, disableOnInteraction: false, }}
                className=" max-main:hidden review-slider w-full h-[300px] overflow-visible transition-all duration-1000 delay-[800ms]
                group-[.animate:not(.show)]:opacity-0 group-[.animate:not(.show)]:translate-y-1/2"
            >
                {nodes?.map((node, i) =>
                    <SwiperSlide key={i}>
